...
def Nthroot(N, p): 
    ...
    f0 = GaussianInteger(25, -108)
    f1 = GaussianInteger(25, 108)
...
print("{", end="")
for i in range(k):
    print((2**18*nthroots[i].re) % p, end=", ")
    print((2**18*nthroots[i].imag) % p, end=", ")
print("};")
print("-----------------------------------------------")
...
print("{", end="")
for i in range(k):
    print((2**18*12241*invNthroots[i].re) % p, end=", ")
    print((2**18*12241*invNthroots[i].imag) % p, end=", ")
print("};")
print("-----------------------------------------------")
