...
if parameter_set == 1:
    import ntt.qtesla_i as roots
    N = 512
    q = 4205569
else:
    if parameter_set == 2:
        import ntt.qtesla_iii_speed as roots
        N = 1024
        q = 8404993
    else:
        if parameter_set == 3:
            import ntt.qtesla_iii_size as roots
            N = 1024
            q = 4206593
        else:
            if parameter_set == 4:
                import ntt.qtesla_p_i as roots
                N = 1024
                q = 485978113
            else:
                if parameter_set == 5:
                    import ntt.qtesla_p_iii as roots
                    N = 2048
                    q = 1129725953
                else:
