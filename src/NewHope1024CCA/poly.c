...
//       r->coeffs[i]   = (montgomery_reduce((uint32_t)copy[i] * nthroots[i]) + 
//                        (NEWHOPE_3Q - 
//                        montgomery_reduce((uint32_t)copy[i+1] * nthroots[i+1])));
      
//       r->coeffs[i+1] = (montgomery_reduce((uint32_t)copy[i] * nthroots[i+1]) + 
//                        montgomery_reduce((uint32_t)copy[i+1] * nthroots[i]));
