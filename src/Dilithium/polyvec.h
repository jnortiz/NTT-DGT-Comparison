...
#define polyvecl_dgt DILITHIUM_NAMESPACE(_polyvecl_dgt)
...
#define polyveck_dgt DILITHIUM_NAMESPACE(_polyveck_dgt)
void polyveck_dgt(polyveck *v);
#define polyveck_invdgt_tomont DILITHIUM_NAMESPACE(_polyveck_invdgt_tomont)
